...
$Popup = GUICreate("Mapper un lecteur", 713, 435, 348, 114)
...
;↓↓==============[DISPLAY THE TEXT INTO THE FILE]==============↓↓
	Refresh()
	Func Refresh()
	$RefreshEdit1 = FileRead("C:\Users\Maxencce\Documents\GitHub\Autoit\mapper\v0.3\mapper.au3")
...
;↓↓==============[OPEN AND WRITE INTO MAPPER.AU3]==============↓↓
			$OpenMapper = FileOpen("C:\Users\Maxencce\Documents\GitHub\Autoit\mapper\v0.3\mapper.au3", 1)
...
;↓↓==============[SAVE THE EDITION INTO THE BOX ($Edit1)]==============↓↓
		Case $Button3
			...
			$ReadEdit1 = GUICtrlRead($Edit1)
			FileWrite($OpenMapper2,$ReadEdit1)
			Refresh()
	EndSwitch
WEnd